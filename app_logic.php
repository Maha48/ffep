...
// Create a message
$body = "Hi there, click on this <a href=\"http://localhost:8888/test-master/new_pass.php?token=" . $token . "\">link</a> to reset your password on our site";
...
if (isset($_POST['new_password'])) {
    ...
    if (isset($_SESSION["token"])){
      //print("token set from session<br>");
